public class MyLinkedList {
	...
	public void insertAfter(int index, int data) {
		...
		// insert after curr, and before curr.next
		Node newNode = new Node(data);
	...
	// assume the node to be deleted exists in the list, and no duplicated keys.
 	public void remove(int dat) {
		...
		if (head.data == dat)
		{
			...
			// remove curr.next
			curr.next = curr.next.next; // by-pass curr.next
		}
	}
    ...
    public static void main(String[] args) {
		...
		ll.insertAfter(2,-4); System.out.printf("insert -4 after index 2: (%d)\t%s\n", ll.len(), ll);
